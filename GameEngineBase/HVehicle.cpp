...
//void HVehicle::buildVehicle( const hkpWorld* world, hkpVehicleInstance& vehicle )
//{
//	//
...
//}
//
//void HVehicle::setupVehicleData( const hkpWorld* world, hkpVehicleData& data )
//{
...
//
//
//void HVehicle::setupComponent( const hkpVehicleData& data, hkpVehicleDefaultAnalogDriverInput& driverInput )
//{
...
//}
//
//void HVehicle::setupComponent( const hkpVehicleData& data, hkpVehicleDefaultSteering& steering )
//{   
...
//}
//
//void HVehicle::setupComponent( const hkpVehicleData& data, hkpVehicleDefaultEngine& engine )
//{
...
//}
//
//void HVehicle::setupComponent( const hkpVehicleData& data, hkpVehicleDefaultTransmission& transmission )
//{
//	int numGears = 4;
//
...
//}
//
//void HVehicle::setupComponent( const hkpVehicleData& data, hkpVehicleDefaultBrake& brake )
//{
...
//}
//
//void HVehicle::setupComponent( const hkpVehicleData& data, hkpVehicleDefaultSuspension& suspension ) 
//{
...
//}
//
//void HVehicle::setupComponent( const hkpVehicleData& data, hkpVehicleDefaultAerodynamics& aerodynamics ) 
//{
...
//}
//
//void HVehicle::setupComponent( const hkpVehicleData& data, hkpVehicleDefaultVelocityDamper& velocityDamper )
//{
...
//}
//
//void HVehicle::setupWheelCollide( const hkpWorld* world, const hkpVehicleInstance& vehicle, hkpVehicleRayCastWheelCollide& wheelCollide )
//{
...
//}
//
//void HVehicle::setupTyremarks( const hkpVehicleData& data, hkpTyremarksInfo& tyreMarks ) 
//{
