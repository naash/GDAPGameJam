...
{
	//Shader IDs
	GLuint _shaderProgram_ID , _vertexShader_ID , _fragmentShader_ID;
	...
	GLuint texId;
	GLuint conTexture;
	GLuint bIsTextureMix;
	GLuint textureMix_LocationID;

	//SkyBox
	GLuint bIsSkyMapID;
	GLuint skyboxTextureVariableID ;
	//Blending
	GLuint bIsBlend;
	GLuint BlendVal;
	//Discard
	...
	//Fog varaibles 
	//GLuint vFogColor_locId; // Fog color
 //  GLuint fStart_locId; // This is only for linear fog
 //  GLuint fEnd_locId; // This is only for linear fog
 //  GLuint fDensity_locId; // For exp and exp2 equation
 //  GLuint iEquation_locId; //Type of Fog 0 = linear, 1 = exp, 2 = exp2 
